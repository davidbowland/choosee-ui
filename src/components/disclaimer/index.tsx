          ...
          <Grid item md sm={12}>
            <Stack spacing={1}>
              <Typography variant="body2">
                ...
                phone number simply to prevent fraud and to keep costs low. Depending on your activity, your IP address
                may appear in our logs for up to 90 days. We never sell your information, but we do collect device and
                site usage information using <Link to="https://aws.amazon.com/pinpoint/">Amazon Pinpoint</Link>.
              </Typography>
              <Typography variant="body2">
