...
import { AlreadyJoined, JoinDialogShell, JoinError, JoinField, JoinHint, JoinSubmit, JoinSuccess } from './elements'
...
export interface JoinSheetProps {
  /**
   * The identifier whose load just failed on the surface this dialog opened over.
   *
...
const JoinSheet = ({ blockedCode, initialValue, isOpen, onClose }: JoinSheetProps): React.ReactNode => {
  ...
  return (
    <JoinDialogShell isOpen={isOpen} onClose={onClose}>
      {renderBody()}
    </JoinDialogShell>
  )
}
